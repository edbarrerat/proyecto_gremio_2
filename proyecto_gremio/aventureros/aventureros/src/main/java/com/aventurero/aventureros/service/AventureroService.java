...
public class AventureroService {
    ...
    public AventureroDTO guardarAventurero(Aventurero aventurero){
        return convertirADTO(aventurero);
    }
    
    public AventureroDTO actualizarAventurero(Integer id,Aventurero aventurero){
